 ...
 * can be wrapped around a MenuItem to create a nested menu
 * Taken from: https://github.com/azmenak/material-ui-nested-menu-item/blob/master/src/index.tsx
 */
...
export interface NestedMenuItemProps extends Omit<MenuItemProps, 'button'> {
   ...
   */
  _MenuProps?: Omit<MenuProps, 'children'>;
  /**
